...
public class Riddle2SceneController extends BaseController {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            UIUtility.animateTypewriterConstant(terminal,
                    "Try booting tracking device...\n" +
                            "Try booting tracking device...\n" +
                            "Try booting tracking device...\n" +
                            "Problems occurred while booting tracking device. Find more information in at/ac/fhcampuswien/trackingdevice/controllers/Riddle2SceneController.bootTrackingDevice() method and at/ac/fhcampuswien/trackingdevice/helpers/BootLoader", new ArrayList<>() {{add(playBtn);}});
